...
def test():
    ...
    # print sess_config.gpu_options.per_process_gpu_memory_fraction
    with tf.Session(config = sess_config) as sess:
        ...
        for image_name in files:
            ...
            def draw_bboxes(img, bboxes, color):
                print 'the length of bboxes is:',len(bboxes)
                for bbox in bboxes:
...
#             print util.sit(mask)
            print util.sit(image_data,image_name=image_name,path=r'../../intermediate_file/detect_result/',bboxes=bboxes_det)
            #'/media/scut214/file/HLG/Chinese_Recognition/test_result3/'
            #/media/scut214/file/HLG/Chinese_Recognition/pixel_link-master/samples_result/
